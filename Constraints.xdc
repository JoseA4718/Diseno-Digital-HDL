...
# LEDs
#set_property PACKAGE_PIN U16 [get_ports {OUTbinario[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {OUTbinario[0]}]
#set_property PACKAGE_PIN E19 [get_ports {OUTbinario[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {OUTbinario[1]}]
#set_property PACKAGE_PIN U19 [get_ports {OUTbinario[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {OUTbinario[2]}]
#set_property PACKAGE_PIN V19 [get_ports {OUTbinario[3]}]					
...
#        set_property IOSTANDARD LVCMOS33 [get_ports {LED[11]}]
    set_property PACKAGE_PIN P3 [get_ports {OUTbinario[3]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {OUTbinario[3]}]
    set_property PACKAGE_PIN N3 [get_ports {OUTbinario[2]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {OUTbinario[2]}]
    set_property PACKAGE_PIN P1 [get_ports {OUTbinario[1]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {OUTbinario[1]}]
    set_property PACKAGE_PIN L1 [get_ports {OUTbinario[0]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {OUTbinario[0]}]
...
#set_property PACKAGE_PIN V7 [get_ports dp] ANODOS					
